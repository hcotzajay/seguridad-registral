...
<div style="margin-top: 3%">
    <div class="card">
        <div class="card-body">
            <h5 style="text-align: center;">Datos de la búsqueda</h5>
            <div>
                <table style="border-color: red">
                    ...
                    <tr>
                        ...
                        <th style="width:200px;font-size: 13px; color: black">{{$datosRecibidos->SEGUNDO_NOMBRE==null?'NULL':$datosRecibidos->SEGUNDO_NOMBRE}}</th>
        ...
        <div class="card-body">
            <table>
                ...
                <tr>
                    ...
                    <th style="width:175px;font-size: 13px;color: black">{{$datosRecibidos->SEGUNDO_APELLIDO==null?'NULL':$datosRecibidos->SEGUNDO_APELLIDO}}</th>
