...
<div style="margin-top: 3%;">
    <div class="card">
        <div class="card-body">
            ...
            {{--          <p style="font-size: 13px; color: black"><b>{{$datosEnviados['primerNombre']}}</b></p>--}}
            <table style="border-color: red">
                ...
                <tr>
                    <th style="width:125px;font-size: 13px; color: black">{{$datosEnviados['primerNombre']}}</th>
                    <th style="width:150px;font-size: 13px; color: black">{{$datosEnviados['segundoNombre']}}</th>
                    <th style="width:150px;font-size: 13px; color: black">{{$datosEnviados['primerApellido']}}</th>
                    <th style="width:150px;font-size: 13px; color: black">{{$datosEnviados['segundoApellido']}}</th>
                    <th style="width:150px;font-size: 13px; color: black">{{$datosEnviados['fechaNacimiento']}}</th>
                </tr>
            </table>
